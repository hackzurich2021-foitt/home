  ...
  <div class="carousel-inner">
   <!--question #1 -->
    <div class="carousel-item active">
      <img class="d-block w-20" src="politics.png" style="max-width:1px" alt="First slide">
      <div class="container">
        <h3>the question is...</h3>
        <br><h5>What is the share of 'No' votes in Kanton-Basel Stadt 13. June 2021 in Auslandschweizer for "Trinkwasser-Initiative"?</h5></br>
        <div id="accordion1">
